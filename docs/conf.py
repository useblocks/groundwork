...
# sphinx-quickstart on Tue Jul 19 14:30:56 2016.
#
...
try:
    release = pkg_resources.get_distribution('groundwork').version
except pkg_resources.DistributionNotFound:
    print('groundwork must be installed to build the documentation.')
...
htmlhelp_basename = 'groundworkdocs'
